...
data = dict(
    ...
    train=dict(
        type='MeterData',
        data_root='/home/dq/gitlab/dataset/table',
        index_file='train_data/list_d.txt',
        pipeline=[
            dict(type='Resize', height=112, width=112),
            dict(type='ColorJitter', brightness=0.3, p=0.5),
            dict(type='MedianBlur', blur_limit=3, p=0.3),
    ...
    val=dict(
        type='MeterData',
        data_root='/home/dq/gitlab/dataset/table',
        index_file='test_data/list_d.txt',
        transform=False),
    test=dict(
        type='MeterData',
        data_root='/home/dq/gitlab/dataset/table',
...
work_dir = '/home/dq/github/edgelab/work_dirs/pfld_mv2n_112/exp8'
auto_resume = False
gpu_ids = [0]
